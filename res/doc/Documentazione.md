...
| `RNF14` | Utilizzo | ![pegi16](../immagini/pegi-16.png)|
...
![Login Wrong User](../immagini/LoginErrorWrongUser.png)

Se il nome utente è corretto e la password è errata, si ha la seguente schermata di errore

![Login Wrong Password](../immagini/LoginErrorWrongPassword.png)
...
![Login Done](../immagini/LoginDone.png)
...
![Login Exit](../immagini/LoginExit.png)
...
![Registration](../immagini/Registration.png)
...
![Registration Date Wrong](../immagini/RegistrationErrorDateWrong.png)

Se l'utente inserisce un username che è già stato preso, allora il client mostrerà la seguente finestra:

![Registration User Wrong](../immagini/RegistrationErrorUserWrong.png)
...
![Game Chooser](../immagini/GameChooser.png)
...
![Game Chooser New Game](../immagini/GameChooserNewGame.png)
...
![Game Chooser New Game Confirm](../immagini/GameChooserNewGameConfirm.png)
...
![Game Chooser Loaded Game](../immagini/GameChooserLoadedGame.png)

Se il server non ha nessun salvataggio e l'utente clicca `Carica`, allora il client mostrerà il seguente messaggio

![Game Chooser Loaded Game Error](../immagini/GameChooserLoadedGameError.png)
...
![Game Chooser Exit](../immagini/GameChooserExit.png)
...
![Game View Save Confirm](../immagini/GameViewSaveConfirm.png)
